    ...
    const handleCheckout = async () => {
        ...
        try {
            ...
            if (product.payment_gateway === 'e2payments') {
                ...
                // Redirect immediately, M-Pesa is push USSD prompt
                window.location.href = `/checkout/sucesso?order_id=${currentOrderId}&e2p=1`;
                return;
            }
                            ...
                            <div className="border border-[#1773B0] rounded-xl overflow-hidden shadow-sm flex flex-col mb-4">
                                ...
                                <div className="bg-[#f5f5f5] p-6 lg:p-8 flex flex-col items-center justify-center text-center">
                                    <div className="w-full">
                                        {(product.currency !== 'ZAR' && product.payment_gateway !== 'e2payments') ? (
