        ...
        <div className="checkout-light-mode min-h-screen bg-gray-50 text-zinc-900">
            ...
            <div className="lg:hidden bg-white border-b border-border">
                ...
                >
                    ...
                    <span className="font-bold">{formatPrice(convertPrice(totalPrice))}</span>
                </button>
                            ...
                            <div className="space-y-1 border-t border-border pt-3">
                                {selectedBumps.map(b => (
                                    <div key={b.product_id} className="flex justify-between text-xs">
                                        ...
                                        <span className="font-medium">{formatPrice(convertPrice(parseFloat(b.product_price ?? '0')))}</span>
                                    </div>
                                ))}
                            </div>
                        )}
                        ...
                        <div className="bg-white rounded-xl border border-border p-6 shadow-sm space-y-4 animate-fade-in">
                            ...
                            <div className="rounded-xl bg-gray-50 border border-gray-200 p-4 space-y-2 text-sm text-gray-800">
                                ...
                                <div className="flex justify-between">
                                    ...
                                    <span className="font-semibold text-gray-900">{formatPrice(convertPrice(basePrice))}</span>
                                </div>
                                {selectedBumps.map(b => (
                            ...
                            <div className="space-y-1.5">
                                ...
                                {selectedBumps.map(b => (
                                    <div key={b.product_id} className="flex justify-between text-xs">
                                        ...
                                        <span className="font-semibold">{formatPrice(convertPrice(parseFloat(b.product_price ?? '0')))}</span>
                                    </div>
                                ))}
                            </div>
                        )}
